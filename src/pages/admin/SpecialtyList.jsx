...
import SpecialtyDoctorsDialog from './SpecialtyDoctorsDialog';
...
const SpecialtyList = () => {
  ...
  const [openDoctorsDialog, setOpenDoctorsDialog] = useState(false);
  ...
  const handleOpenDoctorsDialog = (row) => {
    setSelectedSpecialty(row);
    setOpenDoctorsDialog(true);
  };
  ...
  const actionColumn = {
    ...
    renderCell: (params) => (
      <Box display="flex" gap={1} justifyContent="center">
        <Tooltip title="Xem bác sĩ">
          <button
            className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-700 hover:to-blue-900 text-white font-semibold px-2 rounded-lg shadow-md"
            onClick={() => handleOpenDoctorsDialog(params.row)}
          >
            Doctors
          </button>
        </Tooltip>
  ...
  return (
    ...
    >
      ...
      {/* Doctors dialog */}
      <SpecialtyDoctorsDialog
        open={openDoctorsDialog}
        onClose={() => setOpenDoctorsDialog(false)}
